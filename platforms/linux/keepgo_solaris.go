...
func init() {
	var err error
	interactive, err = IsInteractiveSolaris()
	if err != nil {
		panic(err)
	}
}
...
func (s *solarisService) GetTemplate() *template.Template {
...
func (s *solarisService) GetLogger(errs chan<- error) (Logger, error) {
	if interactive {
...
func IsInteractiveSolaris() (bool, error) {
